...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLabel, QLineEdit, QTextEdit, QListWidget, QHBoxLayout, QVBoxLayout, QInputDialog, QFormLayout
import json
app = QApplication([])
